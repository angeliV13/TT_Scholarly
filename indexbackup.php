...
<body>
    ...
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="justify-content-start align-items-start">
        <div class="container">
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img src="assets/img/desktop2.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-block">
                        <h5 data-aos="fade-up"><?= $website_other['welcome_text'] ?></h5>
                        <p data-aos="fade-up"><?= $website_other['welcome_text'] ?></p>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-5 d-flex align-items-start" data-aos="fade-up" data-aos-delay="300">
                        <div class="content ps-0 ps-lg-10">
                            <p class="fst-italic">
                                <?= $website_info['descr'] ?>
                            </p>
