...
<body>
  ...
  <section id="hero" class="hero justify-content-start align-items-start section-bg">
    ...
    <svg class="hero-waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 30 150 30" preserveAspectRatio="none">
      <defs>
      ...
      <g class="wave2">
        <use xlink:href="#wave-path" x="50" y="10" fill="rgba(255,255,255, .2)">
      </g>
      <g class="wave3">
        <use xlink:href="#wave-path" x="50" y="10" fill="#fff">
      </g>
    </svg>
