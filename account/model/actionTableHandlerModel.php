...
function getProfile($account_id)
{
    ...
    $gradeScore = get_indicators(2, $scholarType, $gwa, $gwa);
    ...
    $typeScore = get_indicators(3, get_school_class($latestSchoolType), $latestSchoolType, 'exa');
    ...
    if ($source != "")
    {
        ...
        $sourceScore = get_indicators(1, $scholarType, $minSource, $maxSource, 'bet');
    }
    ...
    $profile .= '<div class="tab-pane fade" id="bordered-justified-educational-background' . $account_id . '" role="tabpanel" aria-labelledby="educational-background">
                    ...
                    <div class="row g-4 pt-3">
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="Others" class="form-control" id="inputOthers" aria-describedby="inputOthers" value="' . (isset($gen_info['graduation_year']) ? $gen_info['graduation_year'] : "")   . '" disabled>
                        </div>
                        <!-- END FULL NAME -->
                    </div>';
