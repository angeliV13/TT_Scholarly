  ...
  (d.prototype = {
    ...
    getTemplate: function () {
      ...
      switch (
        (this.showInputs
          ? ((b =
              '<input type="text" class="bootstrap-timepicker-hour form-control" maxlength="2"/>'),
            (c =
              '<input type="text" class="bootstrap-timepicker-minute form-control" maxlength="2"/>'),
            (d =
              '<input type="text" class="bootstrap-timepicker-second form-control" maxlength="2"/>'),
            (e =
              '<input type="text" class="bootstrap-timepicker-meridian form-control" maxlength="2"/>'))
    ...
    (a.fn.timepicker.defaults = {
      ...
      icons: {
        ...
        up: "bi bi-arrow-up-circle-fill",
        down: "bi bi-arrow-down-circle-fill"
      },
      maxHours: 24,
      explicitMode: !1,
    }),
