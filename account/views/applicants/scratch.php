    ...
    <div class="tab-content mt-2" id="borderedTabJustifiedContent">
        ...
        <div class="tab-pane fade" id="bordered-justified-educational-background" role="tabpanel" aria-labelledby="educational-background">
            ...
            <?php if ($_SESSION['scholarType'] == 1 or $_SESSION['scholarType'] == 2) : ?>
                <h5 class="text-bold d-flex justify-content-between align-items-center">College Level</h5>
                <!-- Custom Styled Validation with Tooltips -->
            ...
            <?php if ($_SESSION['scholarType'] <= 3) : ?>
                <h5 class="text-bold d-flex justify-content-between align-items-center">Senior Highschool Level</h5>
            ...
            <!-- HIGHSCHOOL LEVEL -->
            <?php if ($_SESSION['scholarType'] <= 3) : ?>
                <h5 class="text-bold d-flex justify-content-between align-items-center">High School Level</h5>
            ...
            <?php if ($_SESSION['scholarType'] <= 4) : ?>
                <h5 class="text-bold d-flex justify-content-between align-items-center">Elementary Level</h5>
