        ...
        <div class="col-lg col-xl-12 col-md-12 col-sm-12">
          <div class="card">
            <div class="rounded-top text-white d-flex flex-row mb-3" style="background-color: #000; height: 200px;">
              ...
              <!-- Profile Info -->
              <div class="ms-3 mt-10 adjustable-line-spacing" style="margin-top: 105px;">
                <h5 class="fw-bold"><?php echo $user_info['first_name'] . " " . $user_info['last_name'] ?></h5>
                <p style="font-size: 15px;">Educational Assistance Scholarship - <?= get_scholar_type($_SESSION['scholarType']) ?><br><?php echo $user_info['eac_number'] ?></p>
              </div>
              ...
              <input type="hidden" id="activeSem" value="<?= $defaultSem ?>">
              <input type="hidden" id="activeAY" value="<?= $defaultAy ?>">
            </div>
            <!-- Edit Profile Button -->
            <?php if ($status['status'] == 1 || (($status['status'] == 0) && ($status['info_flag'] == 1 || $status['educ_flag'] == 1 || $status['family_flag'] == 1))) : ?>
              <div class="p-4 text-black d-grid my-3" style="background-color: #ffff; height: 10px;">
                <button type="button" class="btn btn-outline-warning" id="editInfoProfile">Edit Profile</button>
              </div>
            <?php endif; ?>

            <!-- Bordered Tabs Justified -->
            <div class="text-black mt-3" style="background-color: #ffff;">
              <!-- Adjusted the padding here to center the tabs -->
              <ul class="nav nav-tabs nav-tabs-bordered justify-content-between" id="borderedTabJustified" role="tablist">
                <li class="nav-item justify-content-content" role="presentation">
                  <button class="nav-link fw-bold" id="personal-information" data-bs-toggle="tab" data-bs-target="#bordered-justified-personal-information" type button" role="tab" aria-controls="personal-information" aria-selected="true">Personal Information</button>
                </li>
                <li class="nav-item justify-content-content" role="presentation" id="educBG" data-status="<?= ($status['info_flag'] == 0) ? "disabled" : "" ?>">
                  <button class="nav-link fw-bold" id="educational-background" data-bs-toggle="tab" data-bs-target="#bordered-justified-educational-background" type="button" role="tab" aria-controls="educational-background" aria-selected="false">Educational Background</button>
                </li>
                <li class="nav-item justify-content-content" role="presentation" id="famBG" data-status="<?= ($status['educ_flag'] == 0) ? "disabled" : "" ?>">
                  <button class="nav-link fw-bold" id="family-background" data-bs-toggle="tab" data-bs-target="#bordered-justified-family-background" type="button" role="tab" aria-controls="family-background" aria-selected="false">Family Background</button>
                </li>
                <li class="nav-item justify-content-content" role="presentation" id="addBG" data-status="<?= ($status['family_flag'] == 0) ? "disabled" : "" ?>">
                  <button class="nav-link fw-bold" id="additional-information" data-bs-toggle="tab" data-bs-target="#bordered-justified-additional-information" type="button" role="tab" aria-controls="additional-information" aria-selected="false">Additional Information</button>
                </li>
              </ul>
            </div>
            <div class="card-body p-4">
                ...
                <div class="tab-pane fade" id="bordered-justified-personal-information" role="tabpanel" aria-labelledby="personal-information">
                  <form method="post" id="benefInfo">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-3 col-6 position-relative">
                        <label for="inputSuffix" class="form-label">Extension Name</label>
                      ...
                      <div class="col-md-5 col-12 position-relative">
                        ...
                        <div class="input-group">
                          ...
                          <input form="benefInfo" type="tel" name="Contact Number" class="form-control" id="contact_number" aria-describedby="inputGroupPrepend2" value="<?php echo substr($user_info['contact_number'], 2) ?>" <?= $finishFlag ? "disabled" : "" ?>>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 col-6 position-relative">
                        ...
                        <input form="benefInfo" type="text" name="Zip Code" class="form-control" id="zip_code" aria-describedby="inputZipCode" value="<?php echo $user_info['zip_code'] ?>" <?php echo $user_info['zip_code'] != null ? "disabled" : "" ?>>
                      </div>
                ...
                <div class="tab-pane fade" id="bordered-justified-educational-background" role="tabpanel" aria-labelledby="educational-background">
                  <form method="post" id="educationBG">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-4 col-sm-12 position-relative grad_waiting">
                      ...
                      <div class="col-md-8 col-sm-12 position-relative grad_waiting">
                  ...
                  <?php if ($_SESSION['scholarType'] == 1 or $_SESSION['scholarType'] == 2) : ?>
                    ...
                    <?php if (isset($education[0])) : ?>
                      <div class="row g-3">
                          ...
                          <select class="form-select" name="College Attended" id="c_school" <?= $finishFlag ? "disabled" : "" ?>>
                            ...
                            <?php foreach ($school as $key => $col) : ?>
                              <?php if ($col['school_type'] == 0) : ?>
                                <option value="<?php echo $key ?>" <?php echo $education[0]['school'] == $key ? "selected" : "" ?>><?php echo $col['school_name'] ?></option>
                              <?php endif; ?>
                            <?php endforeach; ?>
                            <?php if (!is_numeric($education[0]['school'])) : ?>
                        ...
                        <div class="col-md-6 col-sm-12 position-relative">
                          <label for="c_otherSchool" class="form-label">If others, kindly input the School Name.</label>
                          <input type="text" name="Other College Attended" class="form-control" id="c_otherSchool" aria-describedby="c_otherSchool" <?= $finishFlag ? "disabled" : "" ?> value="<?= is_numeric($education[0]['school']) ? "" : $education[0]['school'] ?>">
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 position-relative">
                          ...
                          <input type="text" name="Other College Course" class="form-control" id="c_otherCourse" aria-describedby="c_otherCourse" value="<?= is_numeric($education[0]['course']) ? "" : $education[0]['course'] ?>" <?= $finishFlag ? "disabled" : "" ?>>
                        </div>
                        <div class="col-md-6 col-sm-12 position-relative">
                            ...
                            <div class="card-body">
                              <div class="table-responsive">
                                ...
                                <table class="table table-striped header-fixed" id="collegeTable" width="100%" cellspacing="0">
                                  ...
                                  <tbody>
                                    <?php if (isset($education[0]['awards'])) : ?>
                                      <?php foreach ($education[0]['awards'] as $key => $award) : ?>
                                        <tr>
                  ...
                  <?php if ($_SESSION['scholarType'] <= 3) : ?>
                    <?php if (isset($education[1])) : ?>
                      <div class="row g-3">
                        <!-- SENIOR HIGHSCHOOL -->
                        <h5 class="card-title p-2">Senior Highschool Level</h5>
                        <div class="col-md-6 col-sm-12 position-relative">
                        ...
                        <div class="col-md-6 col-sm-12 position-relative">
                          ...
                          <input type="Others" name="Other Senior High School Name" class="form-control" id="s_otherSchool" aria-describedby="s_otherSchool" <?= $finishFlag ? "disabled" : "" ?> value="<?= is_numeric($education[1]['school']) ? "" : $education[1]['school'] ?>">
                        </div>
                        <div class="col-md-2 col-sm-12 position-relative">
                          ...
                          <select class="form-select" id="s_year_level" name="SHS Year Level" <?= $finishFlag ? "disabled" : "" ?>>
                            <option selected disabled value="">Choose...</option>
                            <?php for ($i = 12; $i >= 11; $i--) : ?>
                              <option value="<?php echo $i ?>" <?php echo $education[1]['year_level'] == $i ? "selected" : "" ?>>Grade <?php echo $i ?></option>
                            <?php endfor; ?>
                          </select>
                          <div class="invalid-tooltip">
                            Please select Year Level.
                        ...
                        <div class="col-md-3 col-sm-12 position-relative">
                          ...
                          <select class="form-select" id="s_strand" name="SHS Strand" <?= $finishFlag ? "disabled" : "" ?>>
                            ...
                            <?php foreach ($strand as $key => $str) : ?>
                              <option value="<?php echo $key ?>" <?php echo $education[1]['course'] == $key ? "selected" : "" ?>><?php echo $str ?></option>
                            <?php endforeach; ?>
                          </select>
                          <div class="invalid-tooltip">
                            Please select Course.
                        ...
                        <div class="col-md-7 col-sm-12 position-relative">
                          ...
                          <input type="Others" name="Other SHS Strand" class="form-control" id="s_otherStrand" aria-describedby="s_otherStrand" value="<?= is_numeric($education[1]['course']) ? "" : $education[1]['course'] ?>" <?= $finishFlag ? "disabled" : "" ?>>
                        </div>
                  ...
                  <?php if ($_SESSION['scholarType'] <= 3) : ?>
                    <?php if (isset($education[2])) : ?>
                      <div class="row g-3">
                        <h5 class="card-title p-2">High School Level</h5>
                        ...
                        <div class="col-md-9 col-sm-12 position-relative">
                          ...
                          <input type="Others" name="Other JHS Name" class="form-control" id="j_otherSchool" aria-describedby="j_otherSchool" <?= $finishFlag ? "disabled" : "" ?> value="<?= is_numeric($education[2]['school']) ? "" : $education[2]['school'] ?>">
                        </div>
                        <div class="col-md-3 col-sm-12 position-relative">
                          ...
                          <select class="form-select" id="j_year_level" name="JHS Year Level" <?= $finishFlag ? "disabled" : "" ?>>
                            ...
                            <?php for ($i = 4; $i >= 1; $i--) : ?>
                              <?php if ($i == 1) : ?>
                                <option value="<?php echo $i ?>" <?php echo $education[2]['year_level'] == $i ? "selected" : "" ?>><?php echo $i ?>st Year</option>
                              <?php elseif ($i == 2) : ?>
                                <option value="<?php echo $i ?>" <?php echo $education[2]['year_level'] == $i ? "selected" : "" ?>><?php echo $i ?>nd Year</option>
                              <?php elseif ($i == 3) : ?>
                                <option value="<?php echo $i ?>" <?php echo $education[2]['year_level'] == $i ? "selected" : "" ?>><?php echo $i ?>rd Year</option>
                              <?php else : ?>
                                <option value="<?php echo $i ?>" <?php echo $education[2]['year_level'] == $i ? "selected" : "" ?>><?php echo $i ?>th Year</option>
                              <?php endif; ?>
                            <?php endfor; ?>
                          </select>
                          <div class="invalid-tooltip">
                  ...
                  <?php if ($_SESSION['scholarType'] <= 4) : ?>
                    <?php if (isset($education[3])) : ?>
                      <div class="row g-3">
                        <!-- ELEMENTARY -->
                        <h5 class="card-title p-2">Elementary Level</h5>
                        <div class="col-md-3 position-relative">
                        ...
                        <div class="col-md-7 position-relative">
                          ...
                          <input type="text" name="Other Elementary Name" class="form-control" id="e_otherSchool" aria-describedby="e_otherSchool" <?= $finishFlag ? "disabled" : "" ?> value="<?= is_numeric($education[3]['school']) ? "" : $education[3]['school'] ?>">
                        </div>
                        <div class="col-md-2 position-relative">
                          ...
                          <select class="form-select" id="e_grade_level" name="Elementary Grade Level" <?= $finishFlag ? "disabled" : "" ?>>
                            <option selected disabled value="">Choose...</option>
                            <?php for ($i = 6; $i >= 1; $i--) : ?>
                              <option value="<?php echo $i ?>" <?php echo $education[3]['year_level'] == $i ? "selected" : "" ?>>Grade <?php echo $i ?></option>
                            <?php endfor; ?>
                          </select>
                          <div class="invalid-tooltip">
                            Please select Year Level.
              ...
              <div class="tab-pane fade" id="bordered-justified-family-background" role="tabpanel" aria-labelledby="family-background">
                <form method="post" id="familyBG">
                    ...
                    <div class="row g-4">
                      ...
                      <div class="col-md-3 position-relative">
                        ...
                        <div class="input-group">
                          ...
                          <input type="tel" class="form-control" id="fatherContact" aria-describedby="inputGroupPrepend2" name="Father's Contact Number" <?= $finishFlag ? "disabled" : "" ?> value="<?= substr($family['father']['contact_number'], 2) ?>">
                        </div>
                      </div>
                  ...
                  <?php if (isset($family['mother'])) : ?>
                    <div class="row g-3">
                      ...
                      <div class="col-md-3 position-relative">
                        ...
                        <div class="input-group">
                          <span span class="input-group-text" id="inputGroupPrepend2">+63</span>
                          <input type="tel" class="form-control" id="motherContact" aria-describedby="inputGroupPrepend2" name="Mother's Contact Number" <?= $finishFlag ? "disabled" : "" ?> value="<?= substr($family['mother']['contact_number'], 2) ?>">
                        </div>
                      </div>
                      <!-- END CONTACT INFORMATION -->
                  ...
                  <h5 class="card-title p-2 pt-5">Guardian's Information</h5>
                  ...
                  <?php if (isset($family['guardian'])) : ?>
                    ...
                    <div class="row g-4 <?php echo $family['guardian'] != null ? "" : "d-none" ?>" id="guardianInfo">
                      ...
                      <div class="col-md-3 position-relative">
                        ...
                        <div class="input-group">
                          <span span class="input-group-text" id="inputGroupPrepend2">+63</span>
                          <input type="tel" class="form-control" id="guardianContact" aria-describedby="inputGroupPrepend2" name="Guardian's Contact Number" <?= $finishFlag ? "disabled" : "" ?> value="<?= substr($family['guardian']['contact_number'], 2) ?>">
                        </div>
                      </div>
                      <!-- END CONTACT INFORMATION -->
                  ...
                  <!-- SPOUSE INFORMATION -->
                  <h5 class="card-title p-2 pt-5">Spouse's Information</h5>
                  <div class="col-md-3 position-relative py-4">
                  ...
                  <?php if (isset($family['spouse'])) : ?>
                    ...
                    <div class="row g-4 <?= $family['spouse'] == null ? "d-none" : "" ?>" id="spouseInfo">
                      ...
                      <div class="col-md-3 position-relative">
                        ...
                        <div class="input-group">
                          <span span class="input-group-text" id="inputGroupPrepend2">+63</span>
                          <input type="tel" class="form-control" id="spouseContact" aria-describedby="inputGroupPrepend2" name="Spouse's Contact Number" <?= $finishFlag ? "disabled" : "" ?> value="<?= substr($family['spouse']['contact_number'], 2) ?>">
                        </div>
                      </div>
                      <!-- END CONTACT INFORMATION -->
              ...
              <div class="tab-pane fade" id="bordered-justified-additional-information" role="tabpanel" aria-labelledby="additional-information">
                <form method="post" id="otherInfo">
                  ...
                  <div class="row g-3">
                    <!-- WORKING STUDENT -->
                    <div class="col-md-4 col-sm-12position-relative">
