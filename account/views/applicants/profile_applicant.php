                          ...
                          <?php if (isset($education[3])) : ?>
                            <div class="row g-4">
                              ...
                              <div class="column">
                                <div class="py-3">
                                  <div class="add">
                                    <button class="btn btn-warning" type="button" id="addHSTable" <?= $finishFlag ? "disabled" : "" ?>>Add Awards/Honor</button>
                                  </div>
                                </div>
                                <div class="card">
                                  <div class="header-group mb-3">
                          ...
                          <?php if (isset($education[4])) : ?>
                            <div class="row g-4">
                              ...
                              <div class="column">
                                <div class="py-3">
                                  <div class="add">
                                    <button class="btn btn-warning" type="button" id="addElemTable" <?= $finishFlag ? "disabled" : "" ?>>Add Awards/Honor</button>
                                  </div>
                                </div>
                                <div class="card">
                                  <div class="header-group mb-3">
