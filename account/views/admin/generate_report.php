                                ...
                                <div id="genrep_applicant" class="card-body">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row mb-1 mt-2 justify-content-between">
                                            <form id="genScholarType" class="column position-relative">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div id="courseStrandContainer" class="col-sm-12">
                                                        <select class="form-select" id="courseStrand">
                                                            ...
                                                            <option value="2">2nd Computer Science</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-grid pt-3 gap-2 d-flex justify-content-end">
                                                    <button id="generateReport" class="btn btn-sm btn-danger shadow-sm">Set Query Filter </button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
