        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title">List of Removed Applicants</h5>
                    <button class="btn btn-sm btn-danger" onclick="printData('applicantRemovedTable')"> <i class="bi bi-printer"></i> Print List </button>
                ...
                <div class="table-responsive">
                    <table id="applicantRemovedTable" class="table table-striped header-fixed" width="100%" cellspacing="100%">
                        <thead>
